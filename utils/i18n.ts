...
export const jaMessages = {
  ...
  'Test pattern': 'パターンをテスト',
  'Test pattern {number}': 'パターン{number}をテスト',
  Domain: 'ドメイン',
  'Regular expression': '正規表現',
  'Regular expression quick reference': '正規表現クイックリファレンス',
  'Start of the URL': 'URLの先頭',
  'End of the URL': 'URLの末尾',
  'A literal period': 'ピリオドそのもの',
  'Any sequence of characters': '任意の文字の並び',
  'Either a or b': 'aまたはb',
  'The previous item is optional': '直前の要素を省略可能にする',
  'Example: only a specific path': '例：特定のパスだけを対象にする',
  'Test a URL pattern': 'URLパターンをテスト',
  'Test URL pattern': 'テストするURLパターン',
  URL: 'URL',
  'Test URL': 'テストするURL',
  'Enter a URL pattern and URL to see whether they match.':
    'URLパターンとURLを入力すると一致結果が表示されます。',
  Match: '一致',
  'No match': '不一致',
  'Apply pattern': 'パターンを適用',
  'Cancel pattern test': 'パターンテストをキャンセル',
  Language: '言語',
